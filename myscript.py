...
def Main():
    ...
    while True:
        ...
        out_ping = subprocess.getoutput(["ping 192.168.10.251 -c 1"])
        ...
        valeurPING = out_ping.split('')
        valeurPINGuseless = out_ping.split('')
